    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                GoCheckin helps you manage events and attendees efficiently with
              ...
              <div className="mt-8 flex justify-center space-x-4">
                ...
                <Button
                  variant="outline"
                  onClick={() => router.push("/register/poc")}
                  className="px-8 py-3"
                >
                  Register as POC
                </Button>
              ...
              <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="mt-2 text-gray-600">
                    Register attendees quickly and efficiently with our
                    streamlined system.
                  </p>
                </div>
                ...
                <div className="p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="mt-2 text-gray-600">
                    Track attendance and event metrics in real-time with
                ...
                <div className="p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="mt-2 text-gray-600">
                    Different access levels for admins and point-of-contact
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} GoCheckin. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
